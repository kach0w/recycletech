    ...
    <div className="bg-[#222] sm:pb-20 flex items-center text-center relative overflow-hidden">
      <div className="mx-auto sm:pb-12 md:pt-6 xl:pt-0 z-10">
        ...
        <main className="mt-5 md:mt-20">
          <div className="mx-auto w-[350px] sm:w-[60vw] flex flex-row justify-between sm:space-x-8">
            {/* Section 1 */}
            <div className="flex w-[150px] sm:w-[100px] flex-col items-center text-left">
            ...
            {/* Section 2 */}
            <div className="flex flex-col w-[150px] sm:w-[100px] items-center text-center px-4 ">
            ...
            <div className="hidden sm:flex  sm:flex-col w-[90vw] sm:w-[550px] items-center text-center px-4">
          ...
          <div className="sm:hidden flex flex-row w-[90vw] sm:w-[550px] mt-5 items-center text-center px-4">
              <h3 className="text-1xl font-bold text-white mb-4">RecycleTech is a 501(c)(3) non-profit organization.</h3>
              <a className="text-base text-white rounded-md bg-[#0e465a] hover:bg-[#0e465acc] p-5 font-extrabold border-5" href="/donate">Donate Here</a>
          </div>
            <br></br><br></br>
        ...
        <div className='sm:w-[70vw]'>
            <div className='sm:w-[35vw] inline-block text-white'>
